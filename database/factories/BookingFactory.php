...
class BookingFactory extends Factory
{
    ...
    public function withStartsAt(Carbon $startDate): BookingFactory
    {
    ...
    public function withEndsAt(Carbon $endDate): BookingFactory
    {
    ...
    public function forRoom(Room $room): BookingFactory
    {
